...
const ACRPage = () => {
    const [visible, setVisible] = useState(commonState.navActiveId == 'nav_acr')
    const component = useMemo(() => <ACR />, [])
    useEffect(() => {
      let currentId: CommonState['navActiveId'] = commonState.navActiveId
      const handleNavIdUpdate = (id: CommonState['navActiveId']) => {
        currentId = id
  ...
  const LyricPage = () => {
      const [visible, setVisible] = useState(commonState.navActiveId == 'nav_lyric')
      const component = useMemo(() => <Lyric />, [])
      useEffect(() => {
        let currentId: CommonState['navActiveId'] = commonState.navActiveId
        const handleNavIdUpdate = (id: CommonState['navActiveId']) => {
          currentId = id
...
const Main = () => {
  ...
  const component = useMemo(() => (
    ...
    >
      ...
      <View collapsable={false} key="nav_acr" style={styles.pageStyle}>
        <ACRPage />
      </View>
      <View collapsable={false} key="nav_lyric" style={styles.pageStyle}>
        <LyricPage />
      </View>
